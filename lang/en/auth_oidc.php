...
$string['cfg_email_key'] = 'Email';
$string['cfg_email_desc'] = 'The claim field in token that should map to email';
...
$string['cfg_firstname_key'] = 'Firstname';
$string['cfg_firstname_desc'] = 'The claim field in token that should map to firstname';
...
$string['cfg_lastname_desc'] = 'The claim field in token that should map to lastname';
...
$string['cfg_mapping_key'] = 'User field mapping';
$string['cfg_mapping_desc'] = 'These setting provide a workaround to re-mapping fields when the claim data in the token is non-standard ';
