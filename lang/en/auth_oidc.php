...
$string['errorauthloginfailednouser'] = 'Invalid login: User with username {$a} not found in Moodle. If this site has the "authpreventaccountcreation" setting enabled, this may mean you need an administrator to create an account for you first.';
